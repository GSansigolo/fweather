...
``fweather`` depends essentially on `Requests <https://requests.readthedocs.io/en/master/>`_ and several geospatial libraries. Please, read the instructions below in order to install ``fweather``.
